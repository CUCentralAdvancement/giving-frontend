describe('Fund Search Tests', () => {
  it('Shows proper inputs on search form and handles search input', () => {
    ...
    cy.get('[data-testid="campus-select-list"]').find('select').select('CU Anschutz');
    ...
    // cy.get('[data-testid="search-button"]').click();
    cy.get('[data-testid="interests-select-list"]').find('select').select('Science, Research & Innovation');
    ...
    // cy.get('[data-testid="search-button"]').click();
    cy.get('[data-testid="fund-type-select-list"]').find('select').select('Academic Program Funds');
  ...
  it('Loads fund search page with correct results', () => {
    ...
    cy.get('[data-testid="write-in-link"]').should('have.attr', 'href', '/fund/write-fund');
    ...
    cy.get('[data-testid="search-result"]')
      ...
      .then((result) => {
        ...
        cy.get('[data-testid="fund-card-container"]').within(() => {
          cy.contains(title);
          cy.get('[data-testid="fund-card-campus"]').should('have.attr', 'alt', `${campus} Logo`);
